        ...
        <div className="right-sidebar">
            <div className="sidebar-content">
                <div className="sidebar-buttons">
                    <button className="delete-job"><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Delete job</button>
                    <button className="edit-job"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sidebar-item">
                    <span className="item-label"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Applicants</span>
                    <span className="item-value">400</span>
                </div>
                <div className="sidebar-item">
                    <span className="item-label"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sidebar-item">
                    <span className="item-label"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Messages</span>
                    <span className="item-value">147</span>
                </div>
                <div className="sidebar-item">
                    <span className="item-label"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
